...
Public repository: [HCC-PTPN22-AF35](https://github.com/baseonml71-ui/HCC-PTPN22-AF35). Current public software release: **v1.0.0**. Zenodo archive: [10.5281/zenodo.22899362](https://doi.org/10.5281/zenodo.22899362).
...
The archive includes 59 sanitized frozen analysis/helper sources, historical RC2 packaging copies, fixed definitions, environment records and manuscript-facing source-table exports. See [scope and limitations](docs/REPRODUCIBILITY_SCOPE.md). The first public manuscript-support software release, v1.0.0, is available on GitHub and archived in Zenodo. Release integrity manifests describe the archived v1.0.0 content; main includes subsequent DOI metadata updates.
...
Use [CITATION.cff](CITATION.cff) for the supplied six authors and manuscript title. The software repository is [HCC-PTPN22-AF35](https://github.com/baseonml71-ui/HCC-PTPN22-AF35). Cite the archived v1.0.0 software release using [doi:10.5281/zenodo.22899362](https://doi.org/10.5281/zenodo.22899362).
