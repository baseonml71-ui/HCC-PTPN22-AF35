...
''',encoding='utf-8')
    shutil.copyfile(r'private_dependencies/unavailable_protocol.txt',OUT/'USER_AUTHORIZATION.txt')
    frozen=['AF35_ORDERED_GENES.tsv','AF35_SINGLE_GENE_SUBSET_MANIFEST.tsv','AF35_RANDOM_DROPOUT_SUBSET_MANIFEST.tsv','AF35_COMPONENT_ABLATION_PROTOCOL_FREEZE_v1.md','USER_AUTHORIZATION.txt']
